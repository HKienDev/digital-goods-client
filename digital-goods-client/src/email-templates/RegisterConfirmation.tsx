...
const RegisterConfirmation: React.FC<RegisterConfirmationProps> = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Chào mừng bạn đến với HKZeus Nexus! Xác nhận đăng ký tài khoản</Preview>
      <Tailwind>
          ...
          <Container className="mx-auto my-10 max-w-[600px] rounded-lg bg-white p-8 shadow-lg">
            <Section className="text-center">
              ...
              <Heading className="text-2xl font-bold text-gray-900">
                Chào mừng đến với HKZeus Nexus!
              </Heading>
            ...
            <Section className="text-center">
              ...
              <Text className="mt-4 text-xs text-blue-700 font-medium">
                Cam kết bảo mật: HKZeus Nexus cam kết bảo vệ tuyệt đối thông tin cá nhân và tài khoản của bạn. Mọi dữ liệu đều được mã hóa và không chia sẻ cho bên thứ ba.
              </Text>
            </Section>
          </Container>
        </Body>
